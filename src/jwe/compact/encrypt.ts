...
import type { CompactEncryptClass, FlattenedEncryptClass } from '../../types.i.d'
 ...
 * ```
 */
export default class CompactEncrypt implements CompactEncryptClass<string> {
  private _flattened: FlattenedEncryptClass<FlattenedJWE>
...
export type { KeyLike, JWEKeyManagementHeaderParameters, Readable, JWEHeaderParameters }
