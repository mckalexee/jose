...
*Defined in [jwe/compact/decrypt.ts:62](https://github.com/panva/jose/blob/v3.x/src/jwe/compact/decrypt.ts#L62)*
...
`key` | [KeyLike](../types/_types_d_.keylike.md) \| [CompactDecryptGetKey](../interfaces/_jwe_compact_decrypt_.compactdecryptgetkey.md) | Key, or a function resolving a key, to decrypt the JWE with. |
